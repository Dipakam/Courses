...
def Coorinate_descent( gradFunc, CoordFunc, stepFunc, init, w,X,y,C,d, horizon = 10):
...
def CDP1(X,y,C,d):
  ...
  (theta_SGD, obj_SGD, time_SGD) = Coorinate_descent( CDGradient, getRandCoord, getStepLength, np.random.random_sample( (d+1,) ), w,X,y,C,d ,horizon = 10000)
...
for i in range(len(darray)):
    ...
    finalans.append(CDP1(X,y,1.0,D))
...
plt.scatter( darray,finalans, color = 'g', label = "Coordinate Descent" )
